...
Revision ID: cb0a65b84b4c
Revises: 0854c43a70db
Create Date: 2022-06-16 22:56:24.177309
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "criteria", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "original_criteria",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.Column(
            "tests", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "original_tests",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.Column(
            "objects", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "original_objects",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.Column(
            "states", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "original_states",
            postgresql.JSONB(astext_type=sa.Text()),
    ...
    op.add_column(
        "platforms", sa.Column("contact_mail", sa.Text(), nullable=True)
    )
    op.add_column(
        "platforms", sa.Column("copyright", sa.Text(), nullable=True)
    )
