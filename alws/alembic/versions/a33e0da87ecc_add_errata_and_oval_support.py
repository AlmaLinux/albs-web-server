...
Revision ID: a33e0da87ecc
Revises: 433fd427f579
Create Date: 2022-05-26 15:15:50.620308
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "original_criteria", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("tests", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "original_tests", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("objects", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "original_objects", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("states", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "original_states", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("variables", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "original_variables", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "ref_type",
            sa.Enum("cve", "rhsa", "self_ref", "bugzilla", name="erratareferencetype"),
            nullable=False,
        ),
        sa.Column("errata_record_id", sa.Text(), nullable=False),
