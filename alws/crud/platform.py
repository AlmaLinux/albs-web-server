...
async def modify_platform(
    ...
    db.execute(delete(models.ReferencePlatforms).where(and_(
...
async def get_platforms(
    ...
    db_platforms = db.execute(select(models.Platform).where(condition))
