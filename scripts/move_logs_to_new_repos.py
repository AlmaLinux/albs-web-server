...
from alws.models import Build, Repository, BuildTask, TestTask
from alws.pulp_models import CoreRepositoryContent, CoreContent, CoreContentArtifact
            ...
            for build in builds:
                ...
                for repos in (old_build_logs_repos, old_test_logs_repos):
                    ...
                    subq = (
                        ...
                        .where(
                            CoreRepositoryContent.repository_id.in_(pulp_repo_ids),
                    ...
                    content_to_add = []
                    added_artifacts = []
                    for core_content_artifact in core_arts:
                        artifact = artifacts_mapping[core_content_artifact.content_id]
                        if core_content_artifact.relative_path in added_artifacts:
                            continue
                        added_artifacts.append(core_content_artifact.relative_path)
                        content_to_add.append(artifact.file_href)
